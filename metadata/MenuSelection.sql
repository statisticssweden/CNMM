...
INSERT INTO [dbo].[MenuSelection]([Menu],[Selection],[PresText],[PresTextS],[Description],[LevelNo],[SortCode],[Presentation],[MetaId],[UserId],[LogDate]) VALUES(N'START',N'US',N'',N'Useage statistics',N'Usage statistics',1,N'01',N'A',null,N'script',GETDATE());
INSERT INTO [dbo].[MenuSelection_Sve]([Menu],[Selection],[PresText],[PresTextS],[Description],[SortCode],[Presentation],[UserId],[LogDate]) VALUES(N'START',N'US',N'Användarstatistik',N'Användarstatistik',N'Användarstatistik',N'01',N'A',N'script',GETDATE());
...
INSERT INTO [dbo].[MenuSelection]([Menu],[Selection],[PresText],[PresTextS],[Description],[LevelNo],[SortCode],[Presentation],[MetaId],[UserId],[LogDate]) VALUES(N'US',N'STAT_SUBJECT',N'',N'',N'',5,N'03',N'A',null,N'script',GETDATE());
INSERT INTO [dbo].[MenuSelection_Sve]([Menu],[Selection],[PresText],[PresTextS],[Description],[SortCode],[Presentation],[UserId],[LogDate]) VALUES(N'US',N'STAT_SUBJECT',null,null,N'',N'03',N'A',N'script',GETDATE());