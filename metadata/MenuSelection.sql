...
INSERT INTO [dbo].[MenuSelection]([Menu],[Selection],[PresText],[PresTextS],[Description],[LevelNo],[SortCode],[Presentation],[MetaId],[UserId],[LogDate]) VALUES(N'EN01',N'ENV_WASFAC',N'',N'',N'',5,N'Environment',N'A',null,N'script',GETDATE());
INSERT INTO [dbo].[MenuSelection_Sve]([Menu],[Selection],[PresText],[PresTextS],[Description],[SortCode],[Presentation],[UserId],[LogDate]) VALUES(N'EN01',N'ENV_WASFAC',null,null,N'',N'',N'A',N'script',GETDATE());