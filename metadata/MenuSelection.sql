...
INSERT INTO [dbo].[MenuSelection_Sve]([Menu],[Selection],[PresText],[PresTextS],[Description],[SortCode],[Presentation],[UserId],[LogDate]) VALUES(N'START',N'EN',N'Milj�',N'Milj�',N'Milj�statistik',N'Milj�',N'A',N'script',GETDATE());
...
INSERT INTO [dbo].[MenuSelection_Sve]([Menu],[Selection],[PresText],[PresTextS],[Description],[SortCode],[Presentation],[UserId],[LogDate]) VALUES(N'EN',N'EN01',N'Milj�',N'Milj�',N'',N'',N'A',N'script',GETDATE());
