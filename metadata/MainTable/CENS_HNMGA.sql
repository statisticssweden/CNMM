...
VALUES(N'CENS_HNMGA',N'A',N'Population',N'Population',null,N'TAB001',N'O',null,N'N',N'PO',null,N'CENSUS',N'Year',N'script',GETDATE());

INSERT INTO [dbo].[MainTable_Sve]([MainTable],[PresText],[PresTextS],[ContentsVariable],[UserId],[LogDate]) 
VALUES(N'CENS_HNMGA',N'Folkmängden',N'Folkmängden',null,N'script',GETDATE());
...
-- Creates sub table
INSERT INTO [dbo].[SubTable]([MainTable],[SubTable],[PresText],[CleanTable],[UserId],[LogDate]) VALUES(N'CENS_HNMGA',N'',N'CENS_HNMGA',N'X',N'script',GETDATE());
INSERT INTO [dbo].[SubTable_Sve]([MainTable],[SubTable],[PresText],[UserId],[LogDate]) VALUES(N'CENS_HNMGA',N'',N'CENS_HNMGA',N'script',GETDATE());
